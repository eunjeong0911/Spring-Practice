...
//        result.forEach(System.out::println);
    ...
    void embededTest1(){
        ...
        user.setCompanyAddress(new Address("경기도", "고양시", "고양고양", "2323"));
    ...
    //embedded 된 Address 값이 null 이라면
    @Test
    void embededTest2(){
        ...
        user1.setCompanyAddress(new Address("경기도", "고양시", "고양고양", "2323"));
        userRepository.save(user1);

        User user2 = new User();
        user2.setName("신현아");
        user2.setHomeAddress(null); //Address 가 Null 인 경우  -> null 로 들어감
        user2.setCompanyAddress(null);
        userRepository.save(user2);

        User user3 = new User();
        user3.setName("홍가연");
        user3.setHomeAddress(new Address());    //Address 가 Empty 인 경우 -> null 로 들어감
