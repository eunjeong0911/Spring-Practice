...
//
//        bookRepository.save(book);  //INSERT, bookId의 값은?
...
//                .orElseThrow(RuntimeException::new).getBookId();                    //부모의 id를 얻어오기
//
//        Book result = bookRepository.findById(parentBookId).orElseThrow(RuntimeException::new); //부모접근
//
...
//    }
    ...
    void crudTest3(){
        ...
        Book result = bookReviewInfoRepository
                .findById(1L) //이떄 join문으로 OneToOne 참조하는 부모까지 같이 가져온다 !
                .orElseThrow(RuntimeException::new)
                .getBook(); //그래서 부모값을 참조하고있다.
