...
public class RtController3 {
   ...
   """,
    ...
    public String mapTest1(){
        String url = "http://localhost:8080/server/0"; //반드시 절대경로 이어야 한다.
    ...
    public String mapTest3(){
        String url = "http://localhost:8080/server/1"; //반드시 절대경로 이어야 한다.
...
//    }
    ...
    //Json Object의 배열 -> Java Object(혹은 Map)의 List (혹은 배열)
